...
class SWRLocationData:
    def __init__(self, id: int | None, vanilla_item: str, required_races: int = 0):
        if id == None:
            self.id = None
        else:
...
amateur_course_unlocks_table = {
    "Amateur Race 1 - Course Unlock": SWRLocationData(87, "Amateur Course Unlock"),
    "Amateur Race 2 - Course Unlock": SWRLocationData(88, "Amateur Course Unlock"),
    "Amateur Race 3 - Course Unlock": SWRLocationData(89, "Amateur Course Unlock"),
    "Amateur Race 4 - Course Unlock": SWRLocationData(90, "Amateur Course Unlock"),
    "Amateur Race 5 - Course Unlock": SWRLocationData(91, "Amateur Course Unlock"),
    "Amateur Race 6 - Course Unlock": SWRLocationData(92, "Amateur Course Unlock")
}

semipro_course_unlocks_table = {
    "Semi-Pro Race 1 - Course Unlock": SWRLocationData(93, "Semi-Pro Course Unlock"),
    "Semi-Pro Race 2 - Course Unlock": SWRLocationData(94, "Semi-Pro Course Unlock"),
    "Semi-Pro Race 3 - Course Unlock": SWRLocationData(95, "Semi-Pro Course Unlock"),
    "Semi-Pro Race 4 - Course Unlock": SWRLocationData(96, "Semi-Pro Course Unlock"),
    "Semi-Pro Race 5 - Course Unlock": SWRLocationData(97, "Semi-Pro Course Unlock"),
    "Semi-Pro Race 6 - Course Unlock": SWRLocationData(98, "Semi-Pro Course Unlock")
}

galactic_course_unlocks_table = {
    "Galactic Race 1 - Course Unlock": SWRLocationData(99, "Galactic Course Unlock"),
    "Galactic Race 2 - Course Unlock": SWRLocationData(100, "Galactic Course Unlock"),
    "Galactic Race 3 - Course Unlock": SWRLocationData(101, "Galactic Course Unlock"),
    "Galactic Race 4 - Course Unlock": SWRLocationData(102, "Galactic Course Unlock"),
    "Galactic Race 5 - Course Unlock": SWRLocationData(103, "Galactic Course Unlock"),
    "Galactic Race 6 - Course Unlock": SWRLocationData(104, "Galactic Course Unlock")
}

invitational_course_unlocks_table = {
    "Invitational Race 1 - Course Unlock": SWRLocationData(105, "Invitational Course Unlock"),
    "Invitational Race 2 - Course Unlock": SWRLocationData(106, "Invitational Course Unlock"),
    "Invitational Race 3 - Course Unlock": SWRLocationData(107, "Invitational Course Unlock")
}
